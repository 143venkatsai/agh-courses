...
import courseImage4 from "../assets/courseImage4.png";
import courseImage5 from "../assets/courseImage5.png";
import courseImage6 from "../assets/courseImage6.png";
import courseImage7 from "../assets/courseImage7.png";
import courseImage8 from "../assets/courseImage8.png";
...
export const coursesList = [
  {
    ...
    vectorImage: vector1,
    courseName: "Aptitude + Technical All in One",
    shortName: "Aptitude + Technical",
    rating: 4.4,
    duration: "3 Months",
  ...
  {
    id: 6,
    courseImage: courseImage6,
    vectorImage: vector6,
    courseName: "Master Node.js",
    shortName: "Master Node.js",
    rating: 4.4,
    duration: "3 Months",
    recommendedFor: "All Years",
    prize: "3,999",
  ...
  {
    id: 7,
    courseImage: courseImage7,
    vectorImage: vector7,
    courseName: "Aptitude Complete Preparation",
    shortName: "Aptitude",
    rating: 4.4,
    duration: "1 Year",
  ...
  {
    id: 8,
    courseImage: courseImage8,
    vectorImage: vector8,
    courseName: "Technical Complete Preparation",
    shortName: "Technical",
    rating: 4.4,
    duration: "1 Year",
    recommendedFor: "Pre Final Year",
